...
<link href="https://unpkg.com/@heartexlabs/label-studio@1.5.2/build/static/css/" rel="stylesheet">

<!-- Create the Label Studio container -->
<div id="label-studio"></div>

<!-- Include the Label Studio library -->
<script src="https://unpkg.com/@heartexlabs/label-studio@1.5.2/build/static/js/664.chunk.js"></script>
```
